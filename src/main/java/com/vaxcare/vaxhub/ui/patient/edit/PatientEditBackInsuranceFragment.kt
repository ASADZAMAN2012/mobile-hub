...
@AndroidEntryPoint
class PatientEditBackInsuranceFragment : PatientBaseEditInsuranceFragment() {
    ...
    override val captureTitle: String
        get() = resources.getString(R.string.patient_edit_back_card_subtitle)
    ...
    override fun onActionNext(result: PatientEditInsuranceResult) {
        globalDestinations.goBack(
            this@PatientEditBackInsuranceFragment,
            mapOf(BaseEditInsuranceFragment.BACK_INSURANCE to result)
        )
    }
}
