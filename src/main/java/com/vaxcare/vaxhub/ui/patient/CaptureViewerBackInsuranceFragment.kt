...
@AndroidEntryPoint
class CaptureViewerBackInsuranceFragment : BaseCaptureViewerFragment() {
    @Inject
    @MobilePicasso
    ...
    override fun actionNext(path: String) {
        appointmentViewModel.appointmentCreation.insuranceCardBackPath = path

        destination.goToCurbsideConfirmPatientInfo(this@CaptureViewerBackInsuranceFragment)
    } // 9:15 monday

    override fun actionCancel() {
        globalDestinations.goBack(this@CaptureViewerBackInsuranceFragment)
    }
}
