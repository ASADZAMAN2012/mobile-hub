...
@AndroidEntryPoint
class CaptureViewerFrontInsuranceFragment : BaseCaptureViewerFragment() {
    ...
    override fun actionNext(path: String) {
        appointmentViewModel.appointmentCreation.insuranceCardFrontPath = path

        destination.goToCaptureBackInsurance(this@CaptureViewerFrontInsuranceFragment)
    }

    override fun actionCancel() {
        globalDestinations.goBack(this@CaptureViewerFrontInsuranceFragment)
    }
}
